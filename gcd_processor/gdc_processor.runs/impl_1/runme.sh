...
HD_PWD='C:/Users/under/OneDrive/Escritorio/FESC/2026-1/Diseo de Sistemas Digitales/gdc_processor/gdc_processor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gcd_processor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gcd_processor.tcl -notrace
