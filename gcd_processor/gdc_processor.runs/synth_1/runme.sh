...
HD_PWD='C:/Users/under/OneDrive/Escritorio/FESC/2026-1/Diseo de Sistemas Digitales/gdc_processor/gdc_processor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gcd_processor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gcd_processor.tcl
