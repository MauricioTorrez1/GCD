...
REM
REM Generated by Vivado on Sun Oct 19 18:48:50 -0600 2025
...
echo "xvlog --incr --relax -L uvm -prj gcd_processor_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj gcd_processor_tb_vlog.prj -log xvlog.log
